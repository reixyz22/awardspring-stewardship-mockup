 ...
 *
 * This file only builds the app - no .env loading, no .listen(). Both of
 * those are side effects that a test importing this file shouldn't have to
 * take on: tests set env vars directly and drive requests with supertest,
 * never a real port. server/index.ts is the actual run entry point.
 */
